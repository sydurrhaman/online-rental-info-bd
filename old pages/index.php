...
<!-- Mirrored from house-rent.htmlguru.net/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 May 2017 18:27:47 GMT -->
<head>
    <!-- Basic Page Needs
    ================================================== -->
    <meta charset="utf-8">
    ...
    <!-- Favicons
    ================================================== -->
    <link rel="shortcut icon" href="assets/images/logoa.png">
    ...
    <div class="container">
        <div class="row">
                            ...
                            <ul class="menu-list">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="apartment-single.html">Family House</a>
                                        </li>
                                        <li>
                                            <a href="apartment-single.html">Sublet</a>
                                        </li>
                                        <li>
                                            <a href="apartment-single.html">Bachelor Mess</a>
                                        </li>
                                        <li>
                                            <a href="apartment-single.html">Office</a>
                                        </li>
                                        <li>
                                            <a href="apartment-single.html">Garage</a>
                                        </li>
                                        <li>
                                            <a href="apartment-single.html">Factory</a>
                                        </li>
                                        <li>
                                            <a href="apartment-single.html">Hall Room</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">Musical Instruments & Organizer</a>
                                        </li>
                                        <li>
                                            <a href="#">Corporat Events & Party Organizer</a>
                                        </li>
                                        <li>
                                            <a href="#">PhotoGraphers & VideoGraphers</a>
                                        </li>
                                        <li>
                                            <a href="#">Event Planners & Organizers</a>
                                        </li>
                                        <li>
                                            <a href="#">Food & Catering Services</a>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="blog_post.php">Blog Post</a>
                                        </li>
                                        <li>
            ...
            <div class="col-md-2 col-sm-2">
                <div class="booking">
                    <span><a href="add_adverts.php">Feedback</a></span>
                </div><!-- /.Booking -->
            </div><!-- /.col-md-2 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
...
<div class="slider-area">
    <div class="pogoSlider">
        ...
        <div class="pogoSlider-slide" data-transition="expandReveal" data-duration="1000" style="background-image:url(assets/images/slider-two.jpg);">
            <div class="container-slider one">
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-text-content">
        ...
        <div class="pogoSlider-slide" data-transition="expandReveal" data-duration="1000" style="background-image:url(assets/images/slider-three.jpg);">
            <div class="container-slider one">
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-text-content">
                            <h3 class="pogoSlider-slide-element" data-in="slideDown" data-out="slideUp" data-duration="500" data-delay="500">Good Service is our passion</h3>
                            <h2 class="pogoSlider-slide-element" data-in="slide-left" data-out="slideUp" data-duration="500" data-delay="500">Awesome Event Point</h2>
                            <p class="pogoSlider-slide-element" data-in="slideDown" data-out="slideUp" data-duration="500" data-delay="500">No matter what the weather, no matter what the situation we are in, if we have the right perspective in life, life will always be beautiful!</p>
                            <a href="#" class="button pogoSlider-slide-element" data-in="slideDown" data-out="slideUp" data-duration="500" data-delay="500">Special Offer</a>
                        </div><!-- /.text-content -->
                    </div><!-- /.col-md-12 -->
        ...
        <div class="pogoSlider-slide" data-transition="expandReveal" data-duration="1000" style="background-image:url(assets/images/slider-four.jpg);">
            <div class="container-slider one">
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-text-content">
                            <h3 class="pogoSlider-slide-element" data-in="slideDown" data-out="slideUp" data-duration="500" data-delay="500">Good Service is our passion</h3>
                            <h2 class="pogoSlider-slide-element" data-in="slide-left" data-out="slideUp" data-duration="500" data-delay="500">Awesome Car Point</h2>
                            <p class="pogoSlider-slide-element" data-in="slideDown" data-out="slideUp" data-duration="500" data-delay="500">No matter what the weather, no matter what the situation we are in, if we have the right perspective in life, life will always be beautiful!</p>
                            <a href="#" class="button pogoSlider-slide-element" data-in="slideDown" data-out="slideUp" data-duration="500" data-delay="500">Special Offer</a>
                        </div><!-- /.text-content -->
                    </div><!-- /.col-md-12 -->
        ...
        <div class="pogoSlider-slide" data-transition="expandReveal" data-duration="1000" style="background-image:url(assets/images/slider-five.jpg);">
            <div class="container-slider one">
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-text-content">
        ...
        <div class="pogoSlider-slide" data-transition="expandReveal" data-duration="1000" style="background-image:url(assets/images/slider-six.jpg);">
            <div class="container-slider one">
                <div class="row">
                    <div class="col-md-12">
                        <div class="slider-text-content">
            ...
            <div class="col-md-12">
                <div class="category-menu-content">
                    ...
                    <div class="category-slider bg-white-smoke owl-carousel">
                        ...
                        <div class="item">
                            <div class="category-list style-one">
                                <a href="#"><img src="assets/images/category/category-three.png" alt="" />
                                    <h4>Event</h4></a>
                            </div><!-- /.category-list -->
                        </div><!-- /.item -->
                    </div><!-- /.category-slider -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading-content-three">
                    ...
                    <h5 class="sub-title">Search your <span>Rent</span></h5>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading-content-one">
                    ...
                    <h5 class="sub-title">Welcome to our Rent Company</h5>
                </div><!-- /.heading-content -->
            </div><!-- /.col-md-12 -->
        </div><!-- /.row -->
